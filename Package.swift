...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Leanplum",
            url: "https://github.com/Leanplum/Leanplum-iOS-SDK/releases/download/6.3.0-beta1/Leanplum.xcframework.zip",
            checksum: "dd0d4daf059c30813739be6061d5f96114abebf56fa946708a19930af08bb1de"
        ),
        .target(
