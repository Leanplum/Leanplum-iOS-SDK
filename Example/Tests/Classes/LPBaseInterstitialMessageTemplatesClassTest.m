...
//
//@interface LPBaseInterstitialMessageTemplatesClassTest (Test)
...
//@end
//
//@interface LPBaseInterstitialMessageTemplateClassTest : XCTestCase
//
//@property (nonatomic, strong) LPBaseInterstitialMessageTemplate *baseInterstitial;
//
//@end
//
//@implementation LPBaseInterstitialMessageTemplateClassTest
//
//+ (void)setUp
//{
//    [super setUp];
...
//    self.baseInterstitial = [[LPBaseInterstitialMessageTemplate alloc] init];
//}
//
//- (void)setUp {
//    [super setUp];
...
//{
//    UIImage* image = [self.baseInterstitial imageFromColor:[UIColor blueColor]];
//    XCTAssertNotNil(image);
//}
//
//- (void)test_dismiss_image
//{
//    UIImage* image = [self.baseInterstitial dismissImage:[UIColor blueColor] withSize:128];
//    XCTAssertNotNil(image);
//}
//
